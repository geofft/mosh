...
namespace Terminal
{
  ...
  public:
    ...
    {
      return (bold == x.bold) && (italic == x.italic) &&
             (underlined == x.underlined) && (blink == x.blink) &&
             (inverse == x.inverse) && (invisible == x.invisible) &&
  ...
  public:
    ...
    Cell(int background_color)
        : contents(), fallback(false), width(1), renditions(background_color),
          wrap(false)
    {
    }
    ...
    {
      return ((contents == x.contents) && (fallback == x.fallback) &&
              (width == x.width) && (renditions == x.renditions) &&
              (wrap == x.wrap));
    }
    ...
    bool is_blank(void) const
    {
      return (contents.empty() ||
              ((contents.size() == 1) &&
               ((contents.front() == 0x20) || (contents.front() == 0xA0))));
    }
  ...
  public:
    ...
    bool operator==(const Row &x) const { return (cells == x.cells); }
  ...
  public:
    ...
    int get_scrolling_region_top_row(void) const
    {
      return scrolling_region_top_row;
    }
    int get_scrolling_region_bottom_row(void) const
    {
      return scrolling_region_bottom_row;
    }
    ...
    int get_background_rendition(void) const
    {
      return renditions.background_color;
    }
    ...
    bool operator==(const DrawState &x) const
    {
      ...
      return (width == x.width) && (height == x.height) &&
             (cursor_col == x.cursor_col) && (cursor_row == x.cursor_row) &&
             (cursor_visible == x.cursor_visible) &&
             (reverse_video == x.reverse_video) &&
             (renditions == x.renditions) &&
             (bracketed_paste == x.bracketed_paste) &&
             (vt100_mouse == x.vt100_mouse) && (xterm_mouse == x.xterm_mouse) &&
  ...
  private:
    ...
    bool
        title_initialized; /* true if the window title has been set via an OSC
                              */

    Row newrow(void)
    {
      return Row(ds.get_width(), ds.get_background_rendition());
    }
  ...
  public:
    ...
    const std::deque<wchar_t> &get_window_title(void) const
    {
      return window_title;
    }
    ...
    {
      return (rows == x.rows) && (window_title == x.window_title) &&
